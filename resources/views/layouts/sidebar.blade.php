...
<div class="navbar-right">
    <ul class="navbar-nav">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" title="Notifications" data-toggle="dropdown" role="button"><i class="zmdi zmdi-notifications"></i>
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li><a href="#" class="menu-toggle"><i class="zmdi zmdi-lock"></i><span>Profile</span></a>
                <ul class="ml-menu">
            ...
            <li class="open_top"><a href="#" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Blog Posts</span></a>
                <ul class="ml-menu">
             ...
             <li class="open_top"><a href="#" class="menu-toggle"><i class="zmdi zmdi-dns"></i><span>Blog Categories</span></a>
                <ul class="ml-menu">
            ...
            <li class="open_top"><a href="#" class="menu-toggle"><i class="zmdi zmdi-receipt"></i><span>Newsletter</span></a>
                <ul class="ml-menu">
                    <li><a href="#">Mailing List</a></li>
                </ul>
            </li>
            <li class="active open"><a href="#"><i class="zmdi zmdi-home"></i><span>Logout</span></a></li>
        </ul>
    </div>
</aside>
<!-- Right Sidebar -->
